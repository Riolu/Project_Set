...
<link rel="shortcut icon" href="/favicon.ico"/>
	<title>校园视频 - 新媒体</title>
	<script type="text/javascript" src="/res/js/vms_videos.js"></script>
</head>
<body>
		...
		<div class="shead">
			...
			<div class="navs">
				...
				<ul class="nav">
					...
					<li class="on"><a href="/media.do">校园视频</a><em></em></li>
	...
	<div class="smain">
		<div class="smainl">
			<div class="title"><h3>索引目录</h3><span><a href="http://form.sjtu.edu.cn/infoplus/form/new_media_upload_video/start" target="_blank">上传作品</a></span></div>
			<ul class="m">
				<li class="on"><a href="/media.do?cid=1">媒体聚焦</a></li>
				<li ><a href="/media.do?cid=2">校园电视台</a></li>
				<li ><a href="/media.do?cid=3">网上课堂</a></li>
				<li ><a href="/media.do?cid=4">师生作品</a></li>
			</ul>
		</div>
		<div class="smainr">
			<ul class="mul" id="videolist">
...
$(function(){
	...
	if (uuid != null && uuid != "uuid"){
		var vtitle = "video.name";
		preview_video(vtitle, uuid);
	}
})
</script>
</body>

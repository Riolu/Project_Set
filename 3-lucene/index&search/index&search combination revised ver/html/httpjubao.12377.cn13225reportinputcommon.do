...
<div class="wrap">
  ...
  <input id="msg_idcardnumber" name="enterMessage.idcardnumber" type="hidden" value=""/>
  <input id="msg_reportwork" name="enterMessage.reportwork" type="hidden" value=""/>
  <input id="msg_reportpolitical" name="enterMessage.reportpolitical" type="hidden" value=""/>
  <input id="msg_nameorunit" name="enterMessage.nameorunit" type="hidden" value=""/>
  <input id="msg_qqnumber" name="enterMessage.qqnumber" type="hidden" value=""/>
  <input id="msg_money" name="enterMessage.money" type="hidden" value=""/>
  <input id="msg_nationality" name="enterMessage.nationality" type="hidden" value=""/>
  <input id="msg_birthday" name="enterMessage.birthday" type="hidden" value=""/>
  <input id="msg_volk" name="enterMessage.volk" type="hidden" value=""/>
  <input id="msg_politicalStatus" name="enterMessage.politicalStatus" type="hidden" value=""/>
  <input id="msg_education" name="enterMessage.education" type="hidden" value=""/>
  <input id="msg_telephone" name="enterMessage.telephone" type="hidden" value=""/>
  <input id="msg_onlineYears" name="enterMessage.onlineYears" type="hidden" value=""/>
  <input id="msg_cardType" name="enterMessage.cardType" type="hidden" value=""/>
  <input id="msg_cardOther" name="enterMessage.cardOther" type="hidden" value=""/>
  <input id="msg_cardNumber" name="enterMessage.cardNumber" type="hidden" value=""/>
  <input id="msg_cardNumberNot" name="enterMessage.cardNumberNot" type="hidden" value=""/>
  <input id="msg_company" name="enterMessage.company" type="hidden" value=""/>
  <input id="msg_address" name="enterMessage.address" type="hidden" value=""/>
  
    <div class="info">
      <h1><span>举报人基本信息</span></h1>
      <table width="600" border="0" cellspacing="0" cellpadding="0">
      <input id="randIP" name="randIP" type="hidden" value="202.120.19.1751446016158571"/>
        <tr>
          <td height="30" align="right"><strong>真实姓名：</strong></td>
          <td><input id="userName" name="reportinputbean.name" type="text" maxlength="40" value="" onBlur="isCheck('userName')" dataType="Require" msg="举报人姓名不能为空" okmsg=" "/>
        ...
        <tr>
          ...
          <td>
					女<input id="sex" type="radio" name="reportinputbean.sex" value="0" onBlur="isCheck('sex')" checked="checked"/>
			     	男<input id="sex" type="radio" name="reportinputbean.sex" value="1" onBlur="isCheck('sex')"/>
    ...
    <div>
      ...
      <table width="500" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr id="keywordstyle" style="display: none;">
			...
			<td> 
				<input id="keyword" name="reportinputbean.keyword" type="text" maxlength="64" value="" onBlur="isCheck('keyword')" size="40"/><b> *<label style="font-size:10px " id="keywordLabel"></label></b>
				 <span id="info" />
			</td>
		</tr>
						...
						<tr id="appnameStyle" style="display: none;" >
          					...
          					<td><input id="appname" name="reportinputbean.appname" value="" type="text" maxlength="64" size="40" onBlur="isCheck('appname')" dataType="Require" msg="名称不能为空"  okmsg=" " />
						...
						<tr id="appsourcenameStyle" style="display: none;" > 
							...
							<td>
								<input id="appsourcename" name="reportinputbean.appsourcename" value="" type="text" onBlur="isCheck('appsourcename')" maxlength="80" size="45" dataType="Require" msg="其他下载源不能为空" okmsg=" "/>
        ...
        <tr>
          ...
          <td><select name = "reportinputbean.typecatalog" id="typecatalog" dataType="Require" msg="危害信息大类不能为空"  okmsg=" ">
